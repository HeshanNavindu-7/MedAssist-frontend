...
void main() {
  runApp( ImageApp(imageFilePicker: ImageFilePicker(), client: http.Client()));
}
// coverage:ignore-end

class ImageApp extends StatelessWidget {
  const ImageApp({super.key, required this.imageFilePicker, required this.client});
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: ImageUploder(imageFilePicker: imageFilePicker, client: client),
    );
  }
}

class ImageUploder extends StatefulWidget {
  const ImageUploder({super.key, required this.imageFilePicker, required this.client});
